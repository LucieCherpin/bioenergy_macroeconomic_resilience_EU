...
S1_2030 <- list(
  ...
  adv_bio_kerosene = list(
    ...
    dist_feed = list(
      IVC2_HEFA = c(agriculture = 0.298742, chemicals = 0.105189, adv_biodiesel = 0.298035, adv_biogasoline = 0.298035),
...
S2_2030 <- list(
  ...
  adv_biodiesel = list(
    abs_market_value =  10212747443.18,
    weights = c(IVC11a_road = 0.7826, IVC13a = 0.2174),
  ...
  adv_bio_kerosene = list(
    abs_market_value =  3769095566.81,

    weights = c(IVC6 = 0.7541, IVC11a_SAF = 0.2459),

    prod_cost = list(IVC6 = 2513.829787, IVC11a_SAF =  2843.304112),
    ...
    dist_feed = list(
      ...
      IVC11a_SAF = c(food_bev = 0.01260, agriculture = 0.59772, forestry = 0.12920, paper = 0.14919, sewerage = 0.02331, adv_biodiesel = 0.04399, adv_biogasoline = 0.04399)
    )
  ),
...
S3_2030 <- list(
  ...
  adv_bio_hfo = list(
    ...
    dist_feed = list(
      IVC8a = c(sewerage = 0.023376, food_bev = 0.012637, agriculture = 0.599452, forestry = 0.129575, paper = 0.149622, adv_biodiesel = 0.042669, adv_biogasoline = 0.042669),
      IVC8b = c(adv_biogas = 1.000000),
...
S1_2035 <- list(
  ...
  adv_biodiesel = list(
    ...
    alpha = list(
      IVC1 = c(feed = 0.779271, capex = 0.064680, opex = 0.156049),
      IVC2_HVO = c(feed = 0.6358, capex = 0.115455, opex = 0.130370),
      IVC13a = c(feed = 0.155245, capex = 0.547747, opex = 0.297008)
    ),
  ...
  adv_bio_hfo = list(
    ...
    dist_feed = list(
      IVC8a = c(agriculture = 0.537670, forestry = 0.185998, paper = 0.153292, sewerage = 0.025167, food_bev = 0.012093, adv_biodiesel = 0.042890, adv_biogasoline = 0.042890),
      IVC8b = c(adv_biogas = 1.000000),
...
S2_2035 <- list(
  ...
  adv_bio_kerosene = list(
    ...
    prod_cost = list(IVC6 = 2513.829787, IVC11a_SAF = 2843.304112, IVC13b_SAF = 2005.891082),
...
S1_2040 <- list(
  ...
  adv_bio_kerosene = list(
    ...
    dist_feed = list(
      IVC2_HEFA = c(agriculture = 0.269808, chemicals = 0.109529, adv_biodiesel = 0.310332, adv_biogasoline = 0.310332),
  ...
  adv_bio_hfo = list(
    ...
    dist_feed = list(
      IVC8a = c(agriculture = 0.593056, forestry = 0.146064, paper = 0.141415, sewerage = 0.024132, adv_biodiesel = 0.042447, food_bev = 0.010440, adv_biogasoline = 0.042447),
      IVC8b = c(adv_biogas = 1.000000),
...
S2_2040 <- list(
  ...
  adv_biogasoline = list(
    abs_market_value =  9917650518.53,

    weights = c(IVC5 = 0.14920384, IVC12 = 0.14920384, IVC13a = 0.586055638, IVC13b_road = 0.115536683),
  ...
  adv_bio_hfo = list(
    ...
    dist_feed = list(
      IVC8a = c(agriculture = 0.623109, forestry = 0.118531, paper = 0.139700, sewerage = 0.023256, adv_biodiesel = 0.042341, food_bev = 0.010722, adv_biogasoline = 0.042341),
      IVC8b = c(adv_biogas = 1.000000),
  ...
  conv_biodiesel = list(
    abs_market_value =  14434387717.50,

    weights = c(IVC_T_FF = 0.150968476, IVC_HT_FF = 0.179121139, IVC_T_CC = 0.085401271, IVC_T_lipids = 0.584509113),
...
model_results <- list(
  ...
  metadata = list(
    ...
    # Keep the exact model-side inputs required by the post-processing GHG
    # analysis with the solved endpoint data. This is metadata only: it does
    # not alter any matrix, scenario value, or model calculation.
    ghg_inputs = list(

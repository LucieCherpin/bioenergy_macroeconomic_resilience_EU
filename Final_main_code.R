...
S1_2030 <- list(
  ...
  adv_bio_kerosene = list(
    ...
    prod_cost = list(IVC2_HEFA = 2458.911636, IVC11a_SAF = 2832.004306),

    alpha = list(
      IVC2_HEFA = c(feed = 0.674449, capex = 0.152913, opex = 0.172637),
      IVC11a_SAF = c(feed = 0.236847912, capex = 0.510239337, opex = 0.252912751)
    ),

    dist_feed = list(
      IVC2_HEFA = c(agriculture = 0.298742, adv_biodiesel = 0.298035, chemicals = 0.105189, adv_biogasoline = 0.298035),
      IVC11a_SAF = c(food_bev =  0.01206, agriculture =  0.53611, forestry =  0.18546, paper =  0.15285, sewerage =  0.02509, chemicals = 0.000000, adv_biodiesel =  0.04422, adv_biogasoline =  0.04422)
    )
  ),
...
S1_2035 <- list(
  ...
  adv_bio_kerosene = list(
    ...
    prod_cost = list(IVC2_HEFA = 2458.911636, IVC11a_SAF = 2832.004306, IVC13b_SAF = 2000.298884),
    ...
    dist_feed = list(
      IVC2_HEFA = c(agriculture = 0.298742, adv_biodiesel = 0.298035, chemicals = 0.105189, adv_biogasoline = 0.298035),
      IVC11a_SAF = c(agriculture =  0.5361, forestry =  0.1855, paper =  0.1528, sewerage =  0.0251, food_bev =  0.0121, adv_biodiesel =  0.0442, adv_biogasoline =  0.0442),
...
S2_2035 <- list(
  ...
  adv_bio_kerosene = list(
    ...
    prod_cost = list(IVC2_HEFA = 2356.102815, IVC6 = 2513.829787, IVC11a_SAF = 2843.304112, IVC13b_SAF = 2005.891082),
    ...
    dist_feed = list(
      ...
      IVC6 = c(adv_bio_hfo = 1.000000),
      IVC11a_SAF = c(sewerage =  0.0233, food_bev =  0.0126, agriculture =  0.5977, forestry =  0.1292, paper =  0.1492, adv_biodiesel =  0.0440, adv_biogasoline =  0.0440),
...
S1_2040 <- list(
  ...
  adv_bio_kerosene = list(
    ...
    prod_cost = list(IVC2_HEFA = 2483.258230, IVC11a_SAF = 2864.859741, IVC13b_SAF = 2007.966733),

    alpha = list(
      IVC2_HEFA = c(feed = 0.677641, capex = 0.151414, opex = 0.170945),
      IVC11a_SAF = c(feed = 0.245600066, capex = 0.504387695, opex = 0.250012240),
      IVC13b_SAF = c(feed = 0.343801, capex = 0.341141, opex = 0.315058)
    ),

    dist_feed = list(
      IVC2_HEFA = c(agriculture = 0.269808, adv_biodiesel = 0.310332, chemicals = 0.109529, adv_biogasoline = 0.310332),
      IVC11a_SAF = c(agriculture =  0.56586, forestry =  0.14015, paper =  0.13530, sewerage =  0.02307, adv_biodiesel =  0.06281, food_bev =  0.01000, adv_biogasoline =  0.06281),
...
S2_2040 <- list(
  ...
  adv_bio_kerosene = list(
    ...
    prod_cost = list(IVC2_HEFA = 2431.853820, IVC6 = 2513.829787, IVC11a_SAF = 2870.509644, IVC13b_SAF = 2010.762832),

    alpha = list(
      IVC2_HEFA = c(feed = 0.670827, capex = 0.154615, opex = 0.174558),
      IVC6 = c(feed = 0.423191, capex = 0.298350, opex = 0.278460),
      IVC11a_SAF = c(feed = 0.247084919, capex = 0.503394930, opex = 0.249520151),
    ...
    dist_feed = list(
      ...
      IVC6 = c(adv_bio_hfo = 1.000000),
      IVC11a_SAF = c(agriculture =  0.59525, forestry =  0.11346, paper =  0.13368, sewerage =  0.02223, adv_biodiesel =  0.06255, food_bev =  0.01028, adv_biogasoline =  0.06255),
